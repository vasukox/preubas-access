...
async def lifespan(app: FastAPI):
    ...
    if settings.is_development:
        ...
        try:
            from app.models import usuario, sede, persona, hse, gh  # noqa: F401 — registra todos los modelos en Base.metadata
...
from app.routers.gh import router as gh_router
