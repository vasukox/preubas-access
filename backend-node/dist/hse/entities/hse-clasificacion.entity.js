...
__decorate([
    (0, typeorm_1.Column)({
        name: 'electrico_matricula_contec',
        type: 'enum',
        enum: hse_enum_1.ElectricoMatricula,
        nullable: true,
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({
        name: 'electrico_matricula_archivo',
        type: 'varchar',
        length: 500,
        nullable: true,
    }),
...
__decorate([
    (0, typeorm_1.Column)({
        name: 'caliente_extintor_archivo',
        type: 'varchar',
        length: 500,
        nullable: true,
    }),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => hse_contratista_entity_1.HseContratista, (contratista) => contratista.clasificacion, {
        onDelete: 'CASCADE',
    }),
