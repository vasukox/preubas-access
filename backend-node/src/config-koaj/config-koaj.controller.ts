...
import { TipoContratistaConfig } from './entities/config-tiempos-contratista.entity';
...
export class ConfigKoajController {
  ...
  /** GET /config/tiempos-contratista — retorna los 3 tipos con sus parámetros */
  @Get('tiempos-contratista')
  listarTiemposContratista() {
    return this.configService.listarTiemposContratista();
  }

  /** PUT /config/tiempos-contratista/:tipo — actualiza parámetros de un tipo */
  @Put('tiempos-contratista/:tipo')
  actualizarTiemposContratista(
    @Param('tipo') tipo: string,
    @Body() dto: UpdateTiemposContratistaDto,
  ) {
    return this.configService.actualizarTiemposContratista(
      tipo as TipoContratistaConfig,
      dto,
    );
  }
}
