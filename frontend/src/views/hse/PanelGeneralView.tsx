    ...
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1300, padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '520px', background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-xl)', overflow: 'hidden' }}>
        ...
        <div style={{ padding: '18px 22px', display: 'grid', gap: '12px' }}>
          {error && <div style={{ padding: '10px 12px', borderRadius: 'var(--radius-md)', background: 'rgba(220, 38, 38,0.08)', border: '1px solid rgba(220, 38, 38,0.2)', color: 'var(--danger-400)', fontSize: '0.8rem' }}>{error}</div>}
          <div>
    ...
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1200, padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '700px', background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-xl)', maxHeight: 'calc(100vh - 48px)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '16px 22px', overflowY: 'auto', flex: 1 }}>
          {error && <div style={{ padding: '10px 12px', marginBottom: '12px', borderRadius: 'var(--radius-md)', background: 'rgba(220, 38, 38,0.08)', border: '1px solid rgba(220, 38, 38,0.2)', color: 'var(--danger-400)', fontSize: '0.8rem' }}>{error}</div>}
                ...
                <div key={p.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-md)' }}>
                  ...
                  <div style={{ display: 'flex', gap: '6px' }}>
                    ...
                    <button
                      ...
                      style={{ width: '28px', height: '28px', color: 'var(--danger-400)', borderColor: 'rgba(220, 38, 38,0.15)' }}
                    >
                      <Trash2 size={12} />
                    </button>
                  </div>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background:   form.tipo_contratista === tipo
                          ? tipo === 'ALTO_RIESGO' ? 'rgba(220, 38, 38,0.1)' : 'rgba(22, 163, 74,0.1)'
                          : 'var(--bg-elevated)',
                        border:       `1px solid ${form.tipo_contratista === tipo
                          ? tipo === 'ALTO_RIESGO' ? 'rgba(220, 38, 38,0.4)' : 'rgba(22, 163, 74,0.4)'
                          : 'var(--border-default)'}`,
                        borderRadius: 'var(--radius-md)',
              ...
              >
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                  <span style={{
                    ...
                    border: `1px solid ${a.tipo_contratista === 'ALTO_RIESGO' ? 'rgba(220, 38, 38,0.2)' : 'rgba(22, 163, 74,0.2)'}`,
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button
                    ...
                    className="btn-ghost"
                    style={{ flex: 1, justifyContent: 'center', color: 'var(--danger-400)', borderColor: 'rgba(220, 38, 38,0.15)' }}
                  >
                  ...
                  {a.proveedor_id && (a.contratistas?.length ?? 0) > 0 && (
                    <button
                      ...
                      style={{
                        ...
                        padding: '2px 8px',
                        background: expandedRows.has(a.id) ? 'rgba(15, 23, 42,0.18)' : 'rgba(15, 23, 42,0.08)',
                        border: '1px solid rgba(15, 23, 42,0.25)',
                        borderRadius: '20px',
                        color: 'var(--primary-400)',
