...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    path:  '/parking',
    icon:  <Car size={18} />,
    roles: ['ADMIN_GLOBAL','ADMIN_PARKING','GESTION_PARKING','VIGILANTE_PARKING','VISUALIZADOR'],
    children: [
      {
      ...
      {
        id:    'parking-solicitudes',
        label: 'Solicitudes',
        path:  '/parking/solicitudes',
        icon:  <ClipboardList size={14} />,
        roles: ['ADMIN_GLOBAL','ADMIN_PARKING','GESTION_PARKING'],
      },
      {
        id:    'parking-vehiculos',
        label: 'Vehículos',
        path:  '/parking/vehiculos',
        icon:  <Car size={14} />,
        roles: ['ADMIN_GLOBAL','ADMIN_PARKING','GESTION_PARKING','VISUALIZADOR'],
      },
      {
        id:    'parking-vigilante',
        label: 'Vigilante',
        path:  '/vigilante/parking',
        icon:  <ShieldCheck size={14} />,
        roles: ['ADMIN_GLOBAL','ADMIN_PARKING','VIGILANTE_PARKING'],
      },
      {
        id:    'parking-novedades',
        label: 'Novedades',
        path:  '/parking/novedades',
        icon:  <AlertTriangle size={14} />,
        roles: ['ADMIN_GLOBAL','ADMIN_PARKING','GESTION_PARKING','VIGILANTE_PARKING'],
      },
      {
        id:    'parking-excepciones',
        label: 'Excepciones',
        path:  '/parking/excepciones',
        icon:  <Clock size={14} />,
        roles: ['ADMIN_GLOBAL','ADMIN_PARKING','GESTION_PARKING'],
      },
      {
